 ...
 <div class="container"> 
        <div class="card card-container">
            ...
            <form class="form-signin" action="AdminLoginController" method="post">
                 <br><b>UserName </b> <input type="text" name="username" value="admin"class="form-control" placeholder="Username" required="required" autofocus="autofocus">
               <%if(errorList!=null && errorList.get("errorUsername")!=null){%>
      <p style="color:red;"><%=errorList.get("errorUsername")%></p>
      <%}%>
               <br><b>Password </b> <input type="password" id="inputPassword" value="admin" name="password" class="form-control" placeholder="Password" required>
   ...
   <%--  <form class="form-signin" action="AdminLoginController" method="post">       
      ...
      <input type="text" class="form-control" value="admin" name="username"  placeholder="UserID" required="" autofocus="" />
      <%if(errorList!=null && errorList.get("errorUsername")!=null){%>
      <p style="color:red;"><%=errorList.get("errorUsername")%></p>
      <%}%>
      <input type="password" class="form-control" value="admin" name="password"  placeholder="Password" required=""/>
      <%if(errorList!=null && errorList.get("errorPassword")!=null){%>
      <p style="color:red;"><%=errorList.get("errorPassword")%></p>
      <%}%>
      <%if(errorList!=null && errorList.get("errorInvalidPassword")!=null){%>
